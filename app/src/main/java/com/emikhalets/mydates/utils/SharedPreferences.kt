...
fun Context.spGetNotificationAll() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_ALL, false)
...
fun Context.spGetNotificationMonth() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_MONTH, false)
...
fun Context.spGetNotificationWeek() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_WEEK, false)
...
fun Context.spGetNotificationThreeDay() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_THREE_DAY, false)
...
fun Context.spGetNotificationTwoDay() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_TWO_DAY, false)
...
fun Context.spGetNotificationDay() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_DAY, false)
...
fun Context.spGetNotificationToday() =
    getSharedPreferences(NAME, 0).getBoolean(NOTIFICATION_TODAY, false)
